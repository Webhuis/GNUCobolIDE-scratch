...
from gnucobolide.view.editors import CobolCodeEdit
from gnucobolide.settings import Settings
from gnucobolide.view.dialogs.new_file import DlgNewFile
from .base import Controller
from gnucobolide.view.widgets import FileIconProvider
...
class FileController(Controller):
    ...
    def quit(self):
        ...
        if QtWidgets.QMessageBox.question(
                self.main_window, 'Quit GNUCobolIDE?',
                'Are you sure you want to quit GNUCobolIDE?',
                QtWidgets.QMessageBox.Yes | QtWidgets.QMessageBox.No,
