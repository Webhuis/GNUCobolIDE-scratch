...
import glob
import os
from gnucobolide.system import get_cache_directory
...
def get_path():
    ...
    """
    pth = os.path.join(get_cache_directory(), "GNUCobolIDE-%d.log" % os.getpid())
    return pth
...
def setup_logging(version, level=logging.INFO):
    ...
    ocide_logger = logging.getLogger('gnucobolide')
    ...
    for filename in get_log_files():
        ...
        try:
            ...
            if os.path.exists(pth):
                logging.getLogger('gnucobolide').exception(
